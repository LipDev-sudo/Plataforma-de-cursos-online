  ...
  return (
    <main className="min-h-screen bg-[#0f1020] text-white">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <button className="focus-ring inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold text-white/70 hover:bg-white/10 hover:text-white" onClick={onBack}><ArrowLeft className="h-4 w-4" /> Meu progresso</button>
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_340px]">
          <article className="overflow-hidden rounded-3xl border border-white/10 bg-[#17182c]">
            <div className="flex aspect-video items-center justify-center bg-gradient-to-br from-violet-700 via-indigo-700 to-blue-700 p-8 text-center">
              <div>
                ...
                <p className="mt-5 text-sm font-semibold uppercase tracking-[0.18em] text-cyan-200">Etapa {index + 1} de {demoCourse.lessons.length}</p>
          ...
          <aside className="h-fit rounded-3xl border border-white/10 bg-[#17182c] p-5 lg:sticky lg:top-6">
            <span className="text-xs font-semibold uppercase tracking-[0.16em] text-violet-300">Etapas do percurso</span>
