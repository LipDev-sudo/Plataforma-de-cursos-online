...
const capabilities = [
  { icon: LayoutDashboard, title: "Próxima etapa visível", description: "O painel mostra o avanço atual e indica com clareza onde continuar." },
  ...
  return (
    <section id="recursos" className="scroll-mt-24 bg-white py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center"><span className="eyebrow">Recursos implementados</span><h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Clareza para aprender sem perder o ritmo.</h2><p className="mt-4 text-lg leading-8 text-slate-600">Cada recurso abaixo pode ser testado nesta demonstração pública.</p></div>
