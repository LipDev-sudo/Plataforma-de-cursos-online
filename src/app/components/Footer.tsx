  ...
  return (
    <footer className="border-t border-slate-200 bg-white">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
        <div>
          <a href="#inicio" className="focus-ring inline-flex items-center gap-2 rounded-lg font-bold text-slate-900"><span className="flex h-9 w-9 items-center justify-center rounded-lg bg-violet-700 text-white"><GraduationCap className="h-5 w-5" /></span> SkillFlow</a>
          <p className="mt-3 max-w-lg text-sm leading-6 text-slate-500">Projeto demonstrativo de plataforma de cursos desenvolvido por Hamilton Felipe. Não oferece matrículas, certificados ou pagamentos reais.</p>
        </div>
      ...
      <div className="border-t border-slate-100 px-4 py-5 text-center text-xs text-slate-500">© 2026 Hamilton Felipe · Demonstração educacional</div>
    </footer>
  );
}
